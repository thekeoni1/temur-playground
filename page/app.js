...
//
// THE SPREADSHEET NUMBER CHANGED UNDER US at v0.35.0, and for the better.
// On v0.34.0 this workbook was inflated and built in full, 72 MB of XML,
// which took 29 s and left only 22.8 MB spare: the tightest margin the
// gate ever saw. Every build since refuses it, with "This workbook expands
// to more than 64 MiB; temur will not unpack it", so the read that used to
